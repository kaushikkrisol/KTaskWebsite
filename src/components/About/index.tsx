          ...
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4 lg:w-1/2">
              <div className="mb-12 max-w-[540px] lg:mb-0">
                ...
                🔹 Slack & Microsoft Teams – Get real-time notifications for approvals and status updates.<br/>
                🔹 Google Drive, Dropbox & OneDrive – Store and access artwork files in the cloud.<br/>
                🔹 Zapier API – Automate tasks and integrate with thousands of apps.<br/>
                {/* 💡 Don’t see your tool? Contact us for custom integrations!<br/> */}
