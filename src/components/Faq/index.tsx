    ...
    <section className="relative z-20 overflow-hidden bg-white pb-8 pt-20 dark:bg-dark lg:pb-[50px] lg:pt-[120px]">
      <div className="container">
        <SectionTitle
          ...
          paragraph="In the prepress and printing industry, there are many common challenges and questions that arise, but most can be easily addressed with the right tools and workflows in place."
          width="640px"
          center
        />
        ...
        <div className="-mx-4 mt-[60px] flex flex-wrap lg:mt-20">
          <div className="w-full px-4 lg:w-1/2">
            <SingleFaq
              question=" What is the Prepress Project & Task Management System?"
              answer="Our Prepress Project & Task Management System is an all-in-one platform designed to streamline prepress and print production workflows. It helps design studios, prepress teams, and print production managers manage job tracking, proofing, approvals, and file management—all in one place."
            />
            <SingleFaq
          ...
          <div className="w-full px-4 lg:w-1/2">
            ...
            /><br/><br/>
            <SingleFaq
              question="How does task management work within the system?"
              answer="Our system offers multiple ways to manage tasks, including Gantt, Kanban, and Calendar views. You can assign tasks, set deadlines, and track progress visually, ensuring everything stays on schedule."
            />
          </div>
        </div>
      </div>
