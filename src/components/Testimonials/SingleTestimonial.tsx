...
const SingleTestimonial = ({ testimonial }: { testimonial: Testimonial }) => {
  ...
  return (
    <div className="w-full px-4 md:w-1/2 lg:w-1/3 flex justify-center">
      <div
        className="rounded-xl bg-white px-4 py-[30px] shadow-testimonial dark:bg-dark sm:px-[40px]"
        data-wow-delay=".1s"
      >
        ...
        <div className="flex items-center gap-4">
          <div className="h-[90px] w-[190px] overflow-hidden rounded-full">
